...
{   
    ...
    public static void main(String[] args)
    {
        ...
        BankPayment test_1 = new BankPayment(224, job_1, "3/4/2020", jobseeker_1, InvoiceStatus.Finished, 0);
        BankPayment test_2 = new BankPayment(224, job_1, "3/4/2020", jobseeker_1, InvoiceStatus.Finished, 1000);
        test_1.printData();
        test_2.printData();
    }
}
